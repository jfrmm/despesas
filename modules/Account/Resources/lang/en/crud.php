...
return [
    ...
    'creditor' => [
        'indexed' => 'Creditors indexed.',
        'created' => 'Creditor created.',
        'read' => 'Creditor read.',
        'updated' => 'Creditor updated.',
        'deleted' => 'Creditor deleted.',
        'error' => [
            'creating' => 'Sorry, an error occurred while trying to create the creditor.',
            'reading' => 'Sorry, an error occurred while trying to read the creditor.',
            'updating' => 'Sorry, an error occurred while trying to update the creditor.',
            'deleting' => 'Sorry, an error occurred while trying to delete the creditor.',
            'not_found' => 'Sorry, the creditor was not found.',
        ],
        'relationship' => [
            'indexed' => 'Creditors\'s relationship items indexed.',
            'created' => 'Attached to creditor.',
            'deleted' => 'Detached from creditor.',
            'not_found' => 'Relationship not found.',
            'error' => [
                'creating' => 'Sorry, an error ocurred while trying to attach to the creditor.',
                'deleting' => 'Sorry, an error ocurred while trying to detach from the creditor.',
                'not_found' => 'Sorry, the creditor\'s relationship items were not found.',
            ],
        ],
    ],
];
